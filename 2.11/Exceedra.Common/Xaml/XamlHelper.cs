...
namespace Exceedra.Common.Xaml
{
    public static class XamlHelper
    {
        ...
        public static T FindParent<T>(DependencyObject child, string parentName) where T : DependencyObject
        {
            ...
            //if not move up the visual tree
            if (parent == null) return FindParent<T>(parentObject, parentName);

            // if there is any parentName specified check if it matches
