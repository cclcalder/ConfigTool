...
namespace Exceedra.Controls.UserInterface
{
    /// <summary>
    ...
    public partial class Loader
    {
        public static readonly DependencyProperty IsLoadingProperty =
            DependencyProperty.Register("IsLoading", typeof(bool), typeof(Loader), new UIPropertyMetadata(true));

        public static readonly DependencyProperty CompleteProperty =
        DependencyProperty.Register("Complete", typeof(bool), typeof(Loader), new UIPropertyMetadata(false));

        public static readonly DependencyProperty CloseVisibleProperty =
       DependencyProperty.Register("CloseVisible", typeof(bool), typeof(Loader), new UIPropertyMetadata(true));

        public static readonly DependencyProperty MessageProperty =
            DependencyProperty.Register("Message", typeof(string), typeof(Loader), new UIPropertyMetadata(string.Empty));

        public static readonly DependencyProperty SubMessageProperty =
            DependencyProperty.Register("SubMessage", typeof(string), typeof(Loader), new UIPropertyMetadata(string.Empty));

        public static readonly DependencyProperty ClosePanelCommandProperty =
            DependencyProperty.Register("ClosePanelCommand", typeof(ICommand), typeof(Loader));
        ...
        public bool CloseVisible
        {
            ...
            set
            {
                SetValue(CloseVisibleProperty, !value);
            }
        }
