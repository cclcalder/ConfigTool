...
namespace Website.Webservices
{
    ...
    public class WebService_V2_2 : System.Web.Services.WebService
     {
          [WebMethod]
        public string Run(string storedProcedureName, string parameters)
        {
            ...
            return StaticWS.Run(storedProcedureName, parameters, "ExceedraConn_v2_2");
    ...
    //        try
    //        {
    //            var connStr = WebConfigurationManager.ConnectionStrings["ExceedraConn_v2_2"].ConnectionString;
