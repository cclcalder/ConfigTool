...
namespace WPF.ViewModels
{
    ...
    public class WizardPageViewModel : INotifyPropertyChanged
    {
        ...
        private readonly WizardViewModelBase _parentViewModel;
        ...
        public WizardPageViewModel(WizardViewModelBase parentViewModel, string name)
        {
        ...
        public Func<bool> CanAttemptNavigate
        {
            get
            {
                return _canAttemptNavigate;
            }
            set
            {
                _canAttemptNavigate = value ?? AllGood;

                NotifyPropertyChanged(this, "CanAttemptNavigate");
            }
        }
        ...
        private void NotifyPropertyChanged(WizardPageViewModel viewModel, params string[] propertyNames)
        {
