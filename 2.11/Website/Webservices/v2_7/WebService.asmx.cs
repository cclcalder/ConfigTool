...
namespace Website.Webservices
{
    ...
    public class WebService_V2_7 : System.Web.Services.WebService
    {
        ...
        public string Run(string storedProcedureName, string parameters)
        {
            ...
            return StaticWS.Run(storedProcedureName, parameters, "ExceedraConn_v2_7");
        ...
        //    try
        //    {
        //        var connStr = WebConfigurationManager.ConnectionStrings["ExceedraConn_v2_7"].ConnectionString;
