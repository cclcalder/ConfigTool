...
namespace Website.Webservices
{
    ...
    public class WebService_V2_3 : System.Web.Services.WebService
    {
        [WebMethod]
        public string Run(string storedProcedureName, string parameters)
        {
            ...
            return StaticWS.Run(storedProcedureName, parameters, "ExceedraConn_v2_3");
        ...
        //    try
        //    {
        //        var connStr = WebConfigurationManager.ConnectionStrings["ExceedraConn_v2_3"].ConnectionString;
