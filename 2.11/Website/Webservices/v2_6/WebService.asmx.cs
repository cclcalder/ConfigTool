...
namespace Website.Webservices
{
    ...
    public class WebService_V2_6 : System.Web.Services.WebService
    {
        [WebMethod]
        public string Run(string storedProcedureName, string parameters)
        {
            ...
            return StaticWS.Run(storedProcedureName, parameters, "ExceedraConn_v2_6");
        ...
        //    try
        //    {
        //        var connStr = WebConfigurationManager.ConnectionStrings["ExceedraConn_v2_6"].ConnectionString;
