...
//    {
//        //replace DataContext.SubmitChanges() with
//        public static EntityOp<TEntity> Upsert<TEntity>(this DataContext context, TEntity entity) where TEntity : class
//        {
...
//            if (member == null)
//            {
//                throw new ArgumentException("The parameter selectMember Lambda must be a member accessing lambda such as x => x.Id", "selectMemberLambda");
//            }
//            return member.Member.Name;
//        }

//        public EntityOp(DataContext context, TEntity entity)
//        {
//            Context = context;
//            Entity = entity;
...
//    {
//        public EntityOp(DataContext context, TEntity entity) : base(context, entity) { }
...
//    {
//        public UpsertOp(DataContext context, TEntity entity) : base(context, entity) { }
...
//            //Context.Database.ExecuteSqlCommand(query, valueList.ToArray());
//            //translate to LINQ from EF
//            Context.ExecuteCommand(query, valueList.ToArray());
//        }
//    }
//}